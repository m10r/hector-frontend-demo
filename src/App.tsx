...
import { PoolFarming } from "./views/Farm/Farm";
...
function App() {
  ...
  const isSmallerScreen = useMediaQuery("(max-width: 981px)");
  ...
  useEffect(() => {
    ...
    if (shouldTriggerSafetyCheck()) {
      dispatch(info("Safety Check: Always verify you're on app.hector.finance!"));
    }
  }, []);
